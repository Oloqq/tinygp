...
public class tiny_gp {
    ...
    double run() { /* Interpreter */
        ...
        System.out.println("run should never get here");
        System.exit(5);
        ...
        try {
            ...
            for (i = 0; i < fitnesscases; i ++ ) {
                ...
                for (j = 0; j <= varnumber; j++) {
                    var t = tokens.nextToken().trim();
                    targets[i][j] = Double.parseDouble(t);
                }
            }
    ...
    int grow( char [] buffer, int pos, int max, int depth ) {
        ...
        // // System.out.println("|");
        // System.out.println("buf0: " + (int)buffer[0]);
        ...
        if ( prim == 0 || depth == 0 ) {
            ...
            switch(prim) {
                ...
                case DIV:
                    buffer[pos] = prim;
                    // System.out.println("buf pos: " + (int)buffer[pos]);
    ...
    char [][] create_random_pop(int n, int depth, double [] fitness ) {
        ...
        System.out.println("pop created");
        return( pop );
    }
